...
<script src="lib/js/setting.js?v=<?php echo time();?>"></script>
</head>
<body>
<input type="hidden" id="pages" value="permission">
<div class="container-fluid">
    <?php require_once '../../include_header.php'; ?>
    <div class="row">
        <div class="col-sm-12">
            <div class="row-overflow" style="margin-top:25px;">
                <a href=".setting_tab" class="active get-setting main-tab" pages="permission" data-toggle="tab">
                    <i class="fas fa-user-secret"></i>
                    <span lang="en">Permission</span>
                </a>
            </div>
            <div class="setting_tab tab-pane fade in active"></div>
        </div>
    </div>
</div>
</body>

...
try {
    ...
    // the flat admin-bypass fallback (it's testing PayslipRequestModel, not the payroll approval
    // engine -- see tests/approval_workflow_test.php/payroll_run_test.php for that), so temporarily
    // deactivate whatever's live, entirely inside this script's own rolled-back transaction.

        ...
        <div class="station-filter-body">
            <div class="row g-2">
                <div class="col-6 col-md-3">
                    <label class="form-label small mb-1"><span data-i18n="filter_date_from">From</span></label>
                ...
                <div class="col-6 col-md-3">
                    <label class="form-label small mb-1"><span data-i18n="filter_date_to">To</span></label>
                    <div class="input-group">

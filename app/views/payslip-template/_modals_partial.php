...
<div class="modal fade" id="pstTextModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <textarea id="pstTextModalInput" class="form-control" rows="5"></textarea>
      ...
      <div class="modal-body">
        <div class="row g-3 mb-3">
          <div class="col-auto">
            ...
            <input type="number" class="form-control form-control-sm" id="pstTableRowsInput" min="1" max="20" value="3" style="width:80px;">
          </div>
          <div class="col-auto">
            <label class="form-label small mb-1" data-i18n="ect_table_cols">Columns</label>
            <input type="number" class="form-control form-control-sm" id="pstTableColsInput" min="1" max="10" value="3" style="width:80px;">
          </div>
          <div class="col-auto">
          ...
          <div class="col-auto">
            ...
            <input type="number" class="form-control form-control-sm" id="pstTableBorderWidthInput" min="0" max="10" value="1" style="width:80px;">
          </div>
        </div>

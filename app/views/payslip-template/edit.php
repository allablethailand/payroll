...
<!-- 2026-09-04, Backlog Phase 11, T064 -- shared canvas-designer utilities, must load first (see
     that file's own docblock). This page loads payslip-template.js standalone (outside
     app/views/payslip/settings.php), so it needs its own copy of this script tag too. -->

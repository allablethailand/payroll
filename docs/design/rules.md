...
- **tab/หน้าที่ยิง API ทันทีทุกการกระทำ = ซ่อนปุ่มบันทึกของ footer และปิด dirty-guard ของ tab นั้น** —
  ...
  (ของจริง: tab "รายการจ่าย" และ "ปรับตัวเลข")
- **แก้ค่าในตารางแบบ inline**: เซลล์กลายเป็น `[input (ค่าปัจจุบัน, focus+select)] [บันทึก outline-primary]
  [✗ ghost]` แทนที่ตัวเลขในเซลล์เดิม — Enter = บันทึก, Esc = ยกเลิก, **ค่าเท่าเดิม/ว่าง = ปุ่มบันทึก disabled
  และ Enter ไม่ยิง**, เปิดได้ทีละแถว (เปิดใหม่ปิดเก่า), ระหว่างยิง**ล็อกทั้งตาราง** (การกระทำที่สองจะแข่งกับ
  recalculate ที่ยังไม่จบ) ล้มแล้วค่าที่พิมพ์ยังอยู่ · ปุ่มเปิดแก้ = ไอคอนดินสอ ghost ในคอลัมน์ตัวเลขนั้นเอง

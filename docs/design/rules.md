...
- **ประวัติของแถว = ตารางใต้แถวนั้น ไม่ใช่เมนู/modal** (แก้ 2026-09-19 — ทับกฎ "เมนูประวัติ 3 ส่วน หัว-list-ท้าย"
  ...
  - **แผง 3 ชั้น เลื่อนเฉพาะชั้นล่าง**: (ก) แถบหัว = ค่าที่ระบบคำนวณ (tri-state มี 2 ชนิด = 2 บรรทัด ·
    รายการที่เพิ่มเองไม่มีเลย = ซ้ายว่าง) + ปุ่ม/tag ตามกฎเดิม ซ้าย, **ปุ่มกลม 32px neutral × ขวาสุด ตรงแนว
    ขอบขวาปุ่มในคอลัมน์สุดท้าย** (ชดเชยความกว้าง scrollbar ของชั้น (ค) ด้วย) (ข) หัวคอลัมน์ `sticky top:0`

...
- **แถวที่ไม่เข้าเกณฑ์ (ไม่ได้เข้า SSO/กองทุน) ไม่ซ่อน ไม่มี collapse "แสดง n แถวที่ซ่อน"** — แสดงพร้อม badge
  เหตุผล (`payroll_statutory_skip`), ช่องเงินว่าง, ไม่มีดินสอ

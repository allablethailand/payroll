...
var passCodeTemplate = `
    ...
    <p class="text-center" lang="en">Enter the Passcode you received at</p>
    <p class="text-center text-orange p-email"></p>
    <p class="text-center"><code class="permission_key"></code></p>
    ...
    <p class="text-center" style="margin-top:25px;">
        <button type="button" class="btn btn-orange" onclick="resendPasscode();">Resent Passcode</button>
    </p>
`;
